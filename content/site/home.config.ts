  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        index: "02",
        title: "AI Assistant",
        type: "Server API Integration",
        summary: "A safe server-side assistant flow that keeps model keys out of the browser.",
        impact: "ASK",
        href: "https://example.com/projects/ai-assistant",
        variant: "bang",
      },
      {
        id: "design-system",
        ...
        title: "Design System",
        type: "SCSS Tokens",
        summary: "Theme tokens, responsive sections, and reusable visual patterns for a portfolio.",
        impact: "BUILD",
        href: "https://example.com/projects/design-system",
        variant: "crash",
      },
      {
        id: "deploy-workflow",
        ...
        type: "CI and Hosting",
        summary: "A practical publishing setup with type checks, production builds, and smoke tests.",
        impact: "LIVE",
        href: "https://example.com/projects/deploy-workflow",
        variant: "wham",
      },
    ],
  },
